    ...
    <section @click="gotoAddress('/goods')" class="guide_item">
      <svg class="icon_style">
        <use xmlns:xlink="http://www.w3.org/1999/xlink"
             :xlink:href="$route.path.indexOf('goods') !== -1? '#msiteActive' : '#msite'"></use>
      </svg>
      <span>外卖</span>
    </section>
    <section @click="gotoAddress('/city')" class="guide_item">
      <svg class="icon_style">
        <use xmlns:xlink="http://www.w3.org/1999/xlink"
             :xlink:href="$route.path.indexOf('city') !== -1? '#findActive' : '#find'"></use>
      </svg>
      <span>搜索</span>
    </section>
